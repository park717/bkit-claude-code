...
const { stripAnsi } = require('./progress-bar');
...
/**
 * Resolve feature data from pdcaStatus.
...
/**
 * Pad a line to a given width inside a box (with vertical borders).
 * @param {string} content - Content string (may contain ANSI)
 * @param {number} innerWidth - Available width between borders
 * @returns {string}
 */
